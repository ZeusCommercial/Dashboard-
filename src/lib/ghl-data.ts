...
export async function loadLiveDataset(opts: {
  ...
  // Contacts feed leads-over-time and speed-to-lead metrics. Partner contacts
  // (tagged partner-approved) are excluded since they're affiliates, not leads.
  // Tags are carried through so downstream counts — e.g. paid partners — can
  // still read them off the contact.
